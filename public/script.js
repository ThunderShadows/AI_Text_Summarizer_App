...
function updateCounter() {
  ...
  document.getElementById("char-count").innerText = `Characters: ${text.length}/100,000`;
}
...
// Show Loading Spinner on Summarize
document.getElementById("submit-button").addEventListener("click", () => {
  ...
  setTimeout(() => {
    ...
    document.getElementById("summary").value = "Summarized text will appear here.";
  }, 2000);
});
